...
function deactiveImeiinitialize(countUrlLocal, getNextRecordsUrlLocal) {
	countUrl = countUrlLocal;
	getNextRecordsUrl = getNextRecordsUrlLocal;
	getNoOfDeactiveImeiRecords(searchStringGlobal, locationIdGlb);
}
...
function getNoOfDeactiveImeiRecords(searchString, locationId) {
	$.ajax({
		type : "POST",
		url : countUrl,
		data : {
