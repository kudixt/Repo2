...
function imeiListinitialize(countUrlLocal, getNextRecordsUrlLocal) {
	countUrl = countUrlLocal;
	getNextRecordsUrl = getNextRecordsUrlLocal;
	getNoOfImeiRecords(searchStringGlobal, locationIdGlb);
}
...
function getNoOfImeiRecords(searchString, locationId) {
	$.ajax({
		type : "POST",
		url : countUrl,
		data : {
