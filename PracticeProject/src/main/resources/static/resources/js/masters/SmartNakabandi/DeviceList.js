...
function deviceListinitialize(countUrlLocal, getNextRecordsUrlLocal) {
	countUrl = countUrlLocal;
	getNextRecordsUrl = getNextRecordsUrlLocal;
	getNoOfDeviceRecords(searchStringGlobal, locationIdGlb);
}
...
function getNoOfDeviceRecords(searchString, locationId) {
	$.ajax({
		type : "POST",
		url : countUrl,
		data : {
